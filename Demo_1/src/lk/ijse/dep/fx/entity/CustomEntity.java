...
public class CustomEntity {
    ...
    public CustomEntity(LocalDate rent_date, LocalDate return_date, String name, String address,
                        String telephone, String model, String type, String colour, double vehicle_rate) {
    ...
    public CustomEntity(String vehicle_number, String v_name, String model, String type,
