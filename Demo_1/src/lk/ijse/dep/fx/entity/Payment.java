...
public class Payment extends SuperEntity{
   ...
   private String v_num;
    ...
    public Payment(String pid, LocalDate rent_date, LocalDate return_date, LocalDate date,
                   double rental_amount, double advanced,
                   double extra, double net_total, String c_nic, String v_num) {
        this.pid = pid;
